                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="products-card products-card-short-css">
                                    <div class="product-img">
                                        <a href="shop-details.php">
                                            <img src="assets/images/products/product-img11.png" alt="Products">
                                        </a>
                                        <ul class="products-action-two">
                                            <li><a href="cart.php"><i class="ri-shopping-cart-line"></i></a></li>
                                            <li><a href="compare.php"> <i class="ri-arrow-left-right-line"></i></a></li>
                                    ...
                                    <div class="content">
                                        <h3><a href="shop-details.php">Nail Care Clipper</a></h3>
                                        <span>10.00$</span>
                                        <div class="rating">
                                            <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="products-card products-card-short-css">
                                    <div class="product-img">
                                        <a href="shop-details.php">
                                            <img src="assets/images/products/product-img12.png" alt="Products">
                                        </a>
                                        <ul class="products-action-two">
                                            <li><a href="cart.php"><i class="ri-shopping-cart-line"></i></a></li>
                                            <li><a href="compare.php"> <i class="ri-arrow-left-right-line"></i></a></li>
                                    ...
                                    <div class="content">
                                        <h3><a href="shop-details.php">Striping Tape</a></h3>
                                        <span>22.00$</span>
                                        <div class="rating">
                                            <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="products-card products-card-short-css">
                                    <div class="product-img">
                                        <a href="shop-details.php">
                                            <img src="assets/images/products/product-img13.png" alt="Products">
                                        </a>
                                        <ul class="products-action-two">
                                            <li><a href="cart.php"><i class="ri-shopping-cart-line"></i></a></li>
                                            <li><a href="compare.php"> <i class="ri-arrow-left-right-line"></i></a></li>
                                    ...
                                    <div class="content">
                                        <h3><a href="shop-details.php">Striper Brush</a></h3>
                                        <span>30.00$</span>
                                        <div class="rating">
                                            <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="products-card products-card-short-css">
                                    <div class="product-img">
                                        <a href="shop-details.php">
                                            <img src="assets/images/products/product-img14.png" alt="Products">
                                        </a>
                                        <ul class="products-action-two">
                                            <li><a href="cart.php"><i class="ri-shopping-cart-line"></i></a></li>
                                            <li><a href="compare.php"> <i class="ri-arrow-left-right-line"></i></a></li>
                                    ...
                                    <div class="content">
                                        <h3><a href="shop-details.php">Nail Loose Glitter</a></h3>
                                        <span>26.00$</span>
                                        <div class="rating">
                                            <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="products-card products-card-short-css">
                                    <div class="product-img">
                                        <a href="shop-details.php">
                                            <img src="assets/images/products/product-img15.png" alt="Products">
                                        </a>
                                        <ul class="products-action-two">
                                            <li><a href="cart.php"><i class="ri-shopping-cart-line"></i></a></li>
                                            <li><a href="compare.php"> <i class="ri-arrow-left-right-line"></i></a></li>
                                    ...
                                    <div class="content">
                                        <h3><a href="shop-details.php">Nail Domed Pearls</a></h3>
                                        <span>24.00$</span>
                                        <div class="rating">
                                            <i class="ri-star-fill"></i>
                                            <i class="ri-star-fill"></i>
