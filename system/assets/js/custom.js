...
function calculateEndDate() {
    ...
    if (numberOfDays <= 1) {
        // Calculate the end date when numberOfDays=1 or numberOfDays=0.5
        endDate.setDate(startDate.getDate());
    } else if (partialDayLeave !== 0){
        // Calculate the end date when there partialDayLeave by adding the number of days to the start date
        ...
        endDate.setDate(startDate.getDate() + (Math.floor(numberOfDays) - 1));
    }
