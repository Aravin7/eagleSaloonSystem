...
//01.check the request method
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (empty($message)) {
            ...
            $db = dbConnection();
            //echo 'Connected..!';
            echo $sql = "INSERT INTO tbl_services(ServiceName,Description,Price,Duration,ServiceImage)VALUES('$sName','$sDescription','$sPrice','$sDuration','$file_name_new')";
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="file" id="service_image" name="sImage">
